        ...
        <div className="flex justify-between pt-24 xl:pt-10 flex-wrap lg:flex-nowrap gap-5">
          <div className="w-full lg:w-6/12">
            <div className="flex flex-col gap-12 lg:pt-16 pt-0">
              ...
              <h1 className="text-6xl">I'M Hajra Buksh</h1>
              <div>
